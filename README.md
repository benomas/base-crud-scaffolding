...
php artisan scaffold create controller,request Inegi CatDerechos_transito inegi.cat_derechos_transito &&
...
php artisan scaffold delete controller,request Inegi CatDerechos_transito inegi.cat_derechos_transito &&
